...
const StartingStep: React.FC = () => {
  return (
    <div className="space-y-10 py-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="relative overflow-hidden bg-primary-dark rounded-lg p-10 text-white shadow-2xl border border-white/10 group">
        ...
        <div className="relative z-10">
          <h2 className="text-4xl font-bold mb-6 tracking-tight">Welcome to <span className="text-blue-400">ISAS</span></h2>
          <p className="text-blue-100 text-xl leading-relaxed max-w-3xl font-light">
      ...
      <div className="pt-4">
        <div className="flex items-center justify-between mb-8">
          ...
          <span className="text-xs font-bold text-primary bg-primary-light px-3 py-1 rounded-md uppercase tracking-wider">Real-time Data Sync</span>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={inst.name} className="p-6 rounded-lg border border-gray-100 bg-white flex flex-col gap-4 transition-all hover:border-primary hover:shadow-xl hover:-translate-y-1 group cursor-default">
              <div className={`p-3 ${inst.bg} ${inst.color} rounded-lg w-fit shadow-sm group-hover:scale-110 transition-transform`}>
                <inst.icon size={24} />
              </div>
              <div>
